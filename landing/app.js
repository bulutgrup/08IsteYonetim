...
const I18N = {
  tr:{
    ...
    "foot.privacy_sozlesmesi":"Gizlilik Sözleşmesi",
    "foot.delivery_terms":"Teslimat ve İade Şartları",
    "foot.distance_sales":"Mesafeli Satış Sözleşmesi",
  },
  en:{
    ...
    "foot.about":"About Us",
    "foot.privacy_sozlesmesi":"Privacy Policy",
    "foot.delivery_terms":"Delivery & Return Policy",
    "foot.distance_sales":"Distance Sales Agreement",
  }
};
...
function updateBilling(){
  ...
  // Dynamically update the price unit label based on cycle and language
  const unitText = BILLING==='y' ? (lang==='tr' ? '/ yıl' : '/ yr') : (lang==='tr' ? '/ ay' : '/ mo');
  document.querySelectorAll('[data-price-unit]').forEach(el=>{
